...
export default function ExperiencePage() {
  return (
    <main className="inner-page collection-page"><TopBar /><section className="inner-content">
      ...
      <LivePublishedPosts category="experience" fallback={<div className="collection-placeholder"><span>01</span><div><p>這個書架正在整理</p><h2>經歷會由你親自填入</h2><div>之後可以依「工作與專案」、「學習歷程」、「心得回顧」分類。現在先保留乾淨結構，不替你虛構任何內容。</div></div></div>} />
    </section></main>
  );
}
